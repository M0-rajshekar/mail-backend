...
export const SUPPORTED_BLOCKCHAIN_CODES = Object.values(SupportedBlockchainCode);
...
export const BLOCKCHAIN_CONFIGS: Record<SupportedBlockchainCode, BlockchainConfig> = {
...
export const isValidBlockchainCode = (code: string): code is SupportedBlockchainCode => {
  return SUPPORTED_BLOCKCHAIN_CODES.includes(code as SupportedBlockchainCode);
};

export const getBlockchainConfig = (code: SupportedBlockchainCode): BlockchainConfig => {
